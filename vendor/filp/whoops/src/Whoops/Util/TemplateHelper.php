...
/**
 * Exposes useful tools for working with/in boilerplates
 */
class TemplateHelper
{
    /**
     * An array of variables to be passed to all boilerplates
     * @var array
     */
    private $variables = [];
    ...
    /**
     * Sets the variables to be passed to all boilerplates rendered
